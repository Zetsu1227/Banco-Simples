...
2) Banco
   ...
   + Além disso, é possível salvar os dados do banco atual e carregar os de um salvo.
   + Ao buscar determinada conta com seu número, o usuário é capaz de gerenciar sua conta.
